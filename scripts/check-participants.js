...
async function check() {
  // Query exam_participants table structure and contents
  ...
  if (error) {
    console.error("Error querying exam_participants table:", error);
  } else {
    console.log("exam_participants data sample (5 rows):");
