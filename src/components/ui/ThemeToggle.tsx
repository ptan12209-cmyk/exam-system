...
export function ThemeToggle({
    ...
    return <ThemeToggleInner isOpen={isOpen} setIsOpen={setIsOpen} dropdownRef={dropdownRef} themes={themes} side={side} align={align} />
}
...
function ThemeToggleInner({
    ...
    return (
        <div className="relative" ref={dropdownRef}>
            ...
            {isOpen && (
                <div className={cn(
                    "absolute w-52 rounded-2xl border border-border bg-popover p-2 shadow-xl animate-in fade-in-0 zoom-in-95 z-[100] space-y-2",
