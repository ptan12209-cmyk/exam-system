    ...
    <div className="glass-card p-6 rounded-2xl border border-white/10 bg-neutral-900/50 space-y-4">
      ...
      {showPreview ? (
        <div className="space-y-2">
          ...
          <div className="border border-white/10 rounded-xl bg-neutral-950 p-6 min-h-[300px] overflow-y-auto max-h-[500px] prose prose-invert max-w-none text-sm leading-relaxed text-foreground select-none">
        ...
        <div className="space-y-3">
          ...
          <textarea
            ...
            className="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-foreground font-mono focus:outline-none focus:border-cyan-500/50 focus:ring-1 focus:ring-cyan-500/50 transition-all placeholder:text-muted-foreground/30"
          />

          <div className="flex items-center gap-1.5 text-xs text-muted-foreground bg-white/5 p-3 rounded-xl border border-white/5 leading-relaxed">
      ...
      <div className="flex justify-end gap-3 pt-2 border-t border-white/10">
        ...
        <button
          ...
          onClick={handleSave}
          disabled={saving}
          className="px-4 py-2 text-xs font-semibold rounded-lg bg-cyan-500 hover:bg-cyan-400 text-white flex items-center gap-1.5 transition-all shadow-md"
        >
