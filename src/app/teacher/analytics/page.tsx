  ...
  return (
    <TeacherShell onLogout={handleLogout}>
      ...
      <main className="mx-auto max-w-7xl px-4 pb-24 pt-24 sm:px-6 lg:px-8 lg:py-10">
        ...
        <section className="mt-10 flex flex-col gap-4 rounded-2xl border border-[hsl(var(--border))]/60 bg-[hsl(var(--card))] p-5 shadow-[0_30px_80px_-40px_rgba(0,0,0,0.35)] lg:flex-row lg:items-center lg:justify-between">
