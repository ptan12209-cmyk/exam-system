...
import { GraduationCap, BookOpen, Users, CheckCircle, ArrowRight, Sparkles, Shield, Zap, Trophy } from "lucide-react"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 items-center">
            ...
            <div className="hidden md:flex items-center gap-6 text-sm font-medium text-gray-600 dark:text-gray-300">
              <Link href="/pricing" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Bảng giá</Link>
              <Link href="/resources" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Tài liệu</Link>
              <Link href="/live" className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Lớp học trực tiếp</Link>
            </div>
            <div className="flex items-center gap-3">
              <ThemeToggle />
              <Link href="/login">
      ...
      <section className="pt-20 pb-32 px-4 bg-gradient-to-b from-blue-50/50 via-white to-white dark:from-slate-800 dark:via-slate-900 dark:to-slate-900">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/login">
              <Button size="lg" variant="outline" className="border-gray-300 dark:border-slate-600 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-slate-800 text-lg px-8">
                Đăng nhập
              </Button>
            </Link>
          </div>
          ...
          <div className="mt-16 grid grid-cols-3 gap-8 max-w-xl mx-auto">
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-gray-500 dark:text-gray-400">Bài thi</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-4 bg-white dark:bg-slate-900">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12">
          <div className="p-8 rounded-2xl bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 border border-blue-100 dark:border-blue-800">
            ...
            <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Dành cho Học sinh</h3>
          ...
          <div className="p-8 rounded-2xl bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 border border-purple-100 dark:border-purple-800">
            ...
            <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Dành cho Giáo viên</h3>
            <ul className="space-y-3 text-gray-700 dark:text-gray-300 mb-6">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="flex items-center gap-3">
              ...
              <span className="font-bold text-gray-900 dark:text-white text-lg">LuyenDe 2026</span>
            </div>
            <div className="flex flex-wrap justify-center gap-6 text-sm text-gray-600 dark:text-gray-400">
              <Link href="/pricing" className="hover:text-blue-600 dark:hover:text-blue-400">Bảng giá</Link>
              <Link href="/resources" className="hover:text-blue-600 dark:hover:text-blue-400">Tài liệu</Link>
              <Link href="/live" className="hover:text-blue-600 dark:hover:text-blue-400">Lớp học trực tiếp</Link>
              <a href="mailto:support@luyende.vn" className="hover:text-blue-600 dark:hover:text-blue-400">Liên hệ</a>
            </div>
