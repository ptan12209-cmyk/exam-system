...
import { isRegistrationOpen } from "@/lib/features"
...
export default function HomePage() {
  ...
  const primaryCtaHref = regOpen
    ? "/register"
    : supportZaloUrlWithText("Em muốn tư vấn khóa học online StudyHub")
  const primaryCtaLabel = regOpen ? "Bắt đầu học" : "Tư vấn Zalo"
  const primaryCtaExternal = !regOpen

  const navLinks = [
    { label: "Cách học", href: "#how" },
    { label: "Tính năng", href: "#features" },
    { label: "Đối tượng", href: "#audience" },
    { label: "Khóa học & giá", href: "/" },
  ]
              ...
              {[
                {
                  ...
                  cta: regOpen ? "Tạo tài khoản học" : "Tư vấn Zalo",
                  href: primaryCtaHref,
                },
                {
                  role: "Giáo viên",
          ...
          <div className="relative mx-auto flex max-w-3xl flex-col items-center text-center">
            ...
            >
              <Link
                ...
                style={{ background: ACCENT, color: BG }}
              >
                {regOpen ? "Đăng ký miễn phí" : "Tư vấn Zalo"}
                <ArrowRight size={16} />
              </Link>
              <Link
                href="/login"
        ...
        <footer className="border-t border-white/[0.06] px-5 py-10 sm:px-6 md:px-12">
          <div className="mx-auto flex max-w-6xl flex-col gap-8 md:flex-row md:items-start md:justify-between">
            ...
            <div className="flex flex-wrap gap-x-8 gap-y-2 text-[13px] text-[#8C87A2]">
              ...
              <Link href="/" className="hover:text-[#e8e4f0]">
                Khóa học & giá
              </Link>
              <a
