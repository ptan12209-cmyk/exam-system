    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-slate-950 flex flex-col">
            ...
            <div className="flex-1 flex items-center justify-center p-4">
                <Card className="max-w-md w-full border-gray-200 dark:border-slate-700 shadow-xl bg-white dark:bg-slate-900">
                    <CardContent className="p-8 text-center">
                        ...
                        {/* Success content */}
                        {success && (
                            <div className="bg-gray-50 dark:bg-slate-800 border border-gray-100 dark:border-slate-700 rounded-xl p-5 mb-8">
            ...
            {/* Footer */}
            <footer className="border-t border-gray-200 dark:border-slate-800 py-6 px-4 bg-white dark:bg-slate-950">
