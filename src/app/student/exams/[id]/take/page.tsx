...
export default function TakeExamPage() {
  ...
  useEffect(() => { if (studentAnswers.length || tfStudentAnswers.length || saStudentAnswers.length) localStorage.setItem(localStorageKey, JSON.stringify({ mc: studentAnswers, tf: tfStudentAnswers, sa: saStudentAnswers })) }, [studentAnswers, tfStudentAnswers, saStudentAnswers, localStorageKey])
